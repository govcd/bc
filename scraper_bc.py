"""
Govt. Bangla College, Dhaka (BC) Multi-Batch Automation Scraper
Website: https://sarkaribanglacollege.eshiksaems.com
Credentials: bcstudent / bcstudent
...
BASE_URL = "https://sarkaribanglacollege.eshiksaems.com"
REFERER  = f"{BASE_URL}/Result-Enquiry-Center"
COLLEGE_CODE = "bc"
COLLEGE_NAME = "Govt. Bangla College, Dhaka"
FIXED_PREFIX = "120"
ROLL_DIGITS = 4
...
class PortalSession:
    ...
    def authenticate(self):
        ...
        with sync_playwright() as pw:
            ...
            page.locator("input[name=username]").fill("bcstudent")
            page.locator("input[name=password]").fill("bcstudent")
